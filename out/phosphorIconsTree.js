    ...
    getChildren(element) {
        if (!element) {
            ...
            const filteredCategories = this.searchFilter ?
                categories.filter(cat => cat.toLowerCase().includes(this.searchFilter.toLowerCase()) ||
                    this.iconCategories[cat].some(icon => icon.toLowerCase().includes(this.searchFilter.toLowerCase()))) : categories;
            return Promise.resolve(filteredCategories.map(category => {
                ...
                return new IconTreeItem(category, `${category} (${this.iconCategories[category].length})`, vscode.TreeItemCollapsibleState.Collapsed, 'category', undefined, iconMap[category] || 'folder');
            }));
        }
    ...
    constructor(label, tooltip, collapsibleState, type, iconName, iconThemeName, weight = 'regular') {
        ...
        if (type === 'category') {
            ...
            if (iconName.includes('heart'))
                ...
                symbol = '👤';
            else if (iconName.includes('chat') || iconName.includes('message'))
                symbol = '💬';
                ...
                symbol = '📷';
            else if (iconName.includes('image') || iconName.includes('photo'))
                symbol = '🖼️';
            else if (iconName.includes('video') || iconName.includes('film'))
                symbol = '🎥';
            else if (iconName.includes('music') || iconName.includes('audio'))
                symbol = '🎵';
            else if (iconName.includes('play'))
                symbol = '▶️';
            else if (iconName.includes('pause'))
                symbol = '⏸️';
            else if (iconName.includes('stop'))
                symbol = '⏹️';
            else if (iconName.includes('arrow'))
                symbol = '➡️';
            else if (iconName.includes('chevron'))
                symbol = '❯';
            else if (iconName.includes('caret'))
                symbol = '‣';
            else if (iconName.includes('home'))
                symbol = '🏠';
            else if (iconName.includes('search') || iconName.includes('magnifying'))
                symbol = '🔍';
            else if (iconName.includes('settings') || iconName.includes('gear'))
                symbol = '⚙️';
            else if (iconName.includes('lock'))
                symbol = '🔒';
            else if (iconName.includes('unlock'))
                symbol = '🔓';
            else if (iconName.includes('key'))
                symbol = '🔑';
            else if (iconName.includes('shield'))
                symbol = '🛡️';
            else if (iconName.includes('warning') || iconName.includes('alert'))
                symbol = '⚠️';
            else if (iconName.includes('check'))
                symbol = '✅';
            else if (iconName.includes('close') || iconName.includes('x'))
                symbol = '❌';
            else if (iconName.includes('plus'))
                symbol = '➕';
            else if (iconName.includes('minus'))
                symbol = '➖';
            else if (iconName.includes('calendar') || iconName.includes('date'))
                symbol = '📅';
            else if (iconName.includes('clock') || iconName.includes('time'))
                symbol = '🕐';
            else if (iconName.includes('folder'))
                symbol = '📁';
            else if (iconName.includes('file'))
                symbol = '📄';
            else if (iconName.includes('trash'))
                symbol = '🗑️';
            else if (iconName.includes('download'))
                symbol = '⬇️';
            else if (iconName.includes('upload'))
                symbol = '⬆️';
            else if (iconName.includes('cloud'))
                symbol = '☁️';
            else if (iconName.includes('sun'))
                symbol = '☀️';
            else if (iconName.includes('moon'))
                symbol = '🌙';
            else if (iconName.includes('star'))
                symbol = '⭐';
            else if (iconName.includes('lightning') || iconName.includes('bolt'))
                symbol = '⚡';
            else if (iconName.includes('fire'))
                symbol = '🔥';
            else if (iconName.includes('water'))
                symbol = '💧';
            else if (iconName.includes('tree') || iconName.includes('leaf'))
                symbol = '🌿';
            else if (iconName.includes('flower'))
                symbol = '🌸';
            else if (iconName.includes('car') || iconName.includes('vehicle'))
                symbol = '🚗';
            else if (iconName.includes('plane'))
                symbol = '✈️';
            else if (iconName.includes('ship') || iconName.includes('boat'))
                symbol = '🚢';
            else if (iconName.includes('train'))
                symbol = '🚆';
            else if (iconName.includes('bus'))
                symbol = '🚌';
            else if (iconName.includes('bike') || iconName.includes('bicycle'))
                symbol = '🚲';
            else if (iconName.includes('computer') || iconName.includes('laptop'))
                symbol = '💻';
            else if (iconName.includes('phone') || iconName.includes('mobile'))
                symbol = '📱';
            else if (iconName.includes('tablet'))
                symbol = '📱';
            else if (iconName.includes('keyboard'))
                symbol = '⌨️';
            else if (iconName.includes('mouse'))
                symbol = '🖱️';
            else if (iconName.includes('headphone'))
                symbol = '🎧';
            else if (iconName.includes('battery'))
                symbol = '🔋';
            else if (iconName.includes('wifi'))
                symbol = '📶';
            else if (iconName.includes('bluetooth'))
                symbol = '📶';
            else if (iconName.includes('calculator'))
                symbol = '🧮';
            else if (iconName.includes('shopping') || iconName.includes('cart'))
                symbol = '🛒';
            else if (iconName.includes('store'))
                symbol = '🏪';
            else if (iconName.includes('bank') || iconName.includes('money'))
                symbol = '💰';
            else if (iconName.includes('credit') || iconName.includes('card'))
                symbol = '💳';
            else if (iconName.includes('dollar') || iconName.includes('euro') || iconName.includes('bitcoin'))
                symbol = '💵';
            else if (iconName.includes('game') || iconName.includes('controller'))
                symbol = '🎮';
            else if (iconName.includes('paint') || iconName.includes('brush'))
                symbol = '🎨';
            else if (iconName.includes('scissors'))
                symbol = '✂️';
            else if (iconName.includes('hammer') || iconName.includes('wrench'))
                symbol = '🔧';
            else if (iconName.includes('tool') || iconName.includes('screwdriver'))
                symbol = '🛠️';
            else if (iconName.includes('lightbulb'))
                symbol = '💡';
            else if (iconName.includes('book'))
                symbol = '📚';
            else if (iconName.includes('pencil') || iconName.includes('pen'))
                symbol = '✏️';
            else if (iconName.includes('paper') || iconName.includes('document'))
                symbol = '📄';
            else if (iconName.includes('clipboard'))
                symbol = '📋';
                ...
                symbol = '🔔';
            else if (iconName.includes('notification'))
                symbol = '🔔';
            else if (iconName.includes('bookmark'))
                symbol = '🔖';
            else if (iconName.includes('flag'))
                symbol = '🚩';
            else if (iconName.includes('map') || iconName.includes('location'))
                symbol = '🗺️';
            else if (iconName.includes('compass'))
                symbol = '🧭';
            else if (iconName.includes('earth') || iconName.includes('globe'))
                symbol = '🌍';
            else if (iconName.includes('yin') || iconName.includes('yang'))
                symbol = '☯️';
