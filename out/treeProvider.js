    ...
    getChildren(element) {
        if (!element) {
            ...
            return Promise.resolve(sortedGroups.map((g) => {
                ...
                const groupItem = new SnippetTreeItem(g, vscode.TreeItemCollapsibleState.Collapsed, // Always collapsed initially
                undefined, g);
